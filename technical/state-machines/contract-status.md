...
> [!warning]
> The transition from **Geaccepteerd** to **In verhuur** is automatic only. It runs via a daily cron job (pg_cron or Edge Function) at 01:00 UTC. You cannot trigger this transition from the UI. See [[technical/business-logic/auto-transitions|Auto-transitions]] for details.
...
For full details on these side effects, see [[technical/business-logic/auto-transitions|Auto-transitions]].

## Related pages

- [[technical/state-machines/offer-status|Offer status machine]] -- the preceding lifecycle stage
- [[technical/business-logic/auto-transitions|Auto-transitions]] -- cron job and side effect details
- [[technical/business-logic/invoice-calculations|Invoice calculations]] -- billing logic for active contracts
