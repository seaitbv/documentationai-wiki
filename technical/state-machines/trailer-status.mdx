...
- [Contract status machine](/technical/state-machines/contract-status) -- contract lifecycle that drives automatic trailer status changes
- [Auto-transitions](/technical/business-logic/auto-transitions) -- automatic transition details
