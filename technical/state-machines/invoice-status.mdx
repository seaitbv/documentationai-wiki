...
- [Contract status machine](/technical/state-machines/contract-status) -- contracts that generate invoices
- [Invoice calculations](/technical/business-logic/invoice-calculations) -- how invoice amounts are calculated
- [Auto-transitions](/technical/business-logic/auto-transitions) -- automatic invoice generation on contract status changes
