...
- [Contract status machine](/technical/state-machines/contract-status) -- the next lifecycle stage after offer acceptance
- [Invoice status machine](/technical/state-machines/invoice-status) -- invoice lifecycle for billing
