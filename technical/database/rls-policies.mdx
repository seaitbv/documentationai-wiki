...
<Columns cols="2">
  <Card title="RBAC implementation" href="/technical/auth/rbac" icon="users" horizontal={false}>
    Application-level role-based access control and navigation filtering.
  </Card>

  <Card title="Supabase Auth" href="/technical/auth/supabase-auth" icon="lock" horizontal={false}>
    Authentication configuration and user profile management.
  </Card>
</Columns>
