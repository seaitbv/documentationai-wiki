...
<Columns cols="2">
  <Card title="Tech Stack" href="/technical/architecture/tech-stack" icon="cpu" horizontal={false}>
    Detailed breakdown of frameworks, libraries, and versions used.
  </Card>

  <Card title="Database Schema" href="/technical/database/schema-overview" icon="database" horizontal={false}>
    Complete entity-relationship model and table documentation.
  </Card>

  <Card title="Authentication" href="/technical/auth/overview" icon="lock" horizontal={false}>
    Supabase Auth, Microsoft OAuth, and RBAC implementation.
  </Card>

  <Card title="State Machines" href="/technical/state-machines/offer-status" icon="git-branch" horizontal={false}>
    Status transition rules for offers, contracts, invoices, and trailers.
  </Card>
</Columns>
