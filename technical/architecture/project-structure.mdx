...
app/(app)/
  ...
  communication/              # Communication log pages
  notifications/              # Notification inbox pages
  import-export/              # Import/export wizard pages
  integrations/               # Integration dashboard pages
...
See [Database migrations](/technical/database/migrations) for the full list and descriptions.
