...
<Columns cols="2">
  <Card title="Authentication overview" href="/technical/auth/overview" icon="lock" horizontal={false}>
    Full authentication architecture and flow diagrams.
  </Card>

  <Card title="RBAC" href="/technical/auth/rbac" icon="users" horizontal={false}>
    Role definitions and the application-level access matrix.
  </Card>

  <Card title="RLS policies" href="/technical/database/rls-policies" icon="shield" horizontal={false}>
    Database-level security policies powered by get_user_role().
  </Card>
</Columns>
