...
1. **Database level** -- RLS policies enforce data access per role (documented in [[technical/database/rls-policies|RLS policies]]).
...
- **[[technical/database/rls-policies|RLS policies]]** — Database-level access control and the complete policy listing.

  - **[[technical/auth/overview|Authentication overview]]** — How RBAC fits into the overall authentication architecture.
