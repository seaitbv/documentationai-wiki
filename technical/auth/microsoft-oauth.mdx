...
<Columns cols="2">
  <Card title="Authentication overview" href="/technical/auth/overview" icon="lock" horizontal={false}>
    Full authentication architecture and how Microsoft OAuth fits in.
  </Card>

  <Card title="Supabase Auth" href="/technical/auth/supabase-auth" icon="database" horizontal={false}>
    Primary authentication and session management.
  </Card>
</Columns>
