...
| **Contacts** | Contact | Standalone contact directory across all customers |
| **Documents** | Paperclip | Trailer document management (within Fleet) |
| **Inspections** | Clipboard Check | Technical inspection records (within Fleet) |
| **KM Registrations** | Gauge | Odometer reading management (within Fleet) |
| **Companies** | Building 2 | Company entity management (Admin only) |
| **Locations** | Map Pin | Pick-up location management (Admin only) |
| **Users** | User Cog | User and role management (Admin only) |
| **Communication** | Message Square | Email tracking log for offers and contracts |
| **Notifications** | Bell | System notification inbox |
| **Import/Export** | Arrow Up Down | Bulk data import wizard (Admin, Fleet Manager) |
| **Integrations** | Plug | External system integration dashboard (Admin only) |
| **Audit Log** | Clipboard List | Change tracking and audit trail (Admin only) |
...
| Contacts | Full | Full | Full | Full | Read |
...
| Locations | Full | -- | -- | -- | -- |
| Users | Full | -- | -- | -- | -- |
| Communication | Full | Full | Full | -- | Read |
...
<Columns cols="2">
  ...
  <Card title="Your First Workflow" href="/getting-started/first-workflow" icon="play" horizontal="false">
    Follow a complete offer-to-invoice walkthrough.
  </Card>
</Columns>
