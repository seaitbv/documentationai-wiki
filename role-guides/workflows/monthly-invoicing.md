...
### Step 2: Generate day-based proposals
...
Open **Invoicing** > **Invoice Proposals**.
    ...
    > [!info]
> **Forfait pricing**: contracts with a total duration of 1 day use the forfait rate (default: 120 EUR). Contracts of 2 total days use the 2-day forfait (default: 170 EUR). These are set as system parameters by the Admin. See [[user-guide/invoicing/day-based|Day-Based Invoicing]] for calculation details.

### Step 3: Generate month-based proposals
...
Switch to unit type: **Month**.
    ...
    **Example**: a contract starting on the 26th of a 28-day month = 3/28 = 0.1071... rounded up to **0.11 months**.
    ...
    See [[user-guide/invoicing/month-based|Month-Based Invoicing]] for details.

### Step 4: Generate km-based proposals
...
> Rows highlighted in **red** indicate missing km data. The last km registration is older than the billing period end date. Do not invoice these contracts until km readings are updated.
    ...
    See [[user-guide/invoicing/km-based|Km-Based Invoicing]] for details.

### Step 5: Select proposals and create invoices
...
### Step 6: Review created invoices
...
> Once exported, payment processing and debtor management happen in Exact Online. Payment status is synced back to ARMS.
    ...
    See [[user-guide/invoicing/exact-online-export|Exact Online Export]] for details and troubleshooting.
...
- **[[user-guide/invoicing/proposals|Invoice Proposals]]** — Detailed reference for the proposal generation screen.

  - **[[user-guide/invoicing/day-based|Day-Based Invoicing]]** — Calculation details including forfait pricing and non-driving day deductions.

  - **[[user-guide/invoicing/exact-online-export|Exact Online Export]]** — Export process and error handling.

  - **[[role-guides/by-role/accounting|Accounting Role Guide]]** — Complete overview of the Accounting role.
