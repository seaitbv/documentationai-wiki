...
<Steps>
  <Step title="Create or select a customer" icon="user-plus" titleType="h3">
    **Role**: Commercial
    ...
    See [Creating a Customer](/user-guide/customers/creating-customer) | [VIES Validation](/user-guide/customers/vies-validation) | [Contacts](/user-guide/customers/contacts)
  </Step>

  <Step title="Create the offer" icon="file-plus" titleType="h3">
    **Role**: Commercial
    ...
    See [Creating an Offer](/user-guide/offers/creating-offer)
  </Step>
  ...
  <Step title="Send the offer via Outlook" icon="mail" titleType="h3">
    **Role**: Commercial
    ...
    See [Sending via Outlook](/user-guide/offers/sending-outlook)
  </Step>

  <Step title="Process the customer's response" icon="message-circle" titleType="h3">
    **Role**: Commercial
    ...
    See [Offer Lifecycle](/user-guide/offers/lifecycle)
  </Step>
  ...
  <Step title="Convert the offer to a contract" icon="arrow-right-circle" titleType="h3">
    ...
    **Advance calculation by unit type:**
    ...
    See [Converting to Contract](/user-guide/offers/converting-to-contract) | [Deposits & Advances](/user-guide/contracts/deposits-advances)
  </Step>

  <Step title="Send and accept the contract" icon="handshake" titleType="h3">
    **Role**: Commercial
    ...
    See [Contract Lifecycle](/user-guide/contracts/lifecycle) | [Sending via Outlook](/user-guide/contracts/sending-outlook)
  </Step>

  <Step title="Automatic transition to In Rental" icon="play" titleType="h3">
    **Automatic** (system)
    ...
    See [Contract Lifecycle](/user-guide/contracts/lifecycle)
  </Step>

  <Step title="During the rental period" icon="calendar" titleType="h3">
    **Roles**: Commercial (non-driving days), Fleet Manager (km registrations)
    ...
    See [Non-Driving Days](/user-guide/contracts/non-driving-days) | [Km Registration](/user-guide/fleet/km-registration)
  </Step>

  <Step title="Generate invoice proposals" icon="clipboard-list" titleType="h3">
    **Role**: Accounting
    ...
    See [Invoice Proposals](/user-guide/invoicing/proposals) | [Day-Based](/user-guide/invoicing/day-based) | [Month-Based](/user-guide/invoicing/month-based) | [Km-Based](/user-guide/invoicing/km-based)
  </Step>

  <Step title="Create and export invoices" icon="upload" titleType="h3">
    **Role**: Accounting
    ...
    See [Managing Invoices](/user-guide/invoicing/managing-invoices) | [Exact Online Export](/user-guide/invoicing/exact-online-export)
  </Step>

  <Step title="Trailer return and contract completion" icon="undo" titleType="h3">
    **Roles**: Commercial (status change), Fleet Manager (inspection)
    ...
    See [Trailer Return Workflow](/role-guides/workflows/trailer-return) | [Damage Control](/user-guide/contracts/damage-control)
  </Step>
</Steps>
...
<Columns cols="2">
  <Card title="Monthly Invoicing" href="/role-guides/workflows/monthly-invoicing" icon="calendar" horizontal="false">
    Detailed monthly invoicing cycle for the Accounting role.
  </Card>

  <Card title="Trailer Return" href="/role-guides/workflows/trailer-return" icon="undo" horizontal="false">
    Post-return inspection and damage control workflow.
  </Card>

  <Card title="Fleet Onboarding" href="/role-guides/workflows/fleet-onboarding" icon="truck" horizontal="false">
    Adding a new trailer to the fleet.
  </Card>

  <Card title="FAQ" href="/help/faq" icon="message-circle" horizontal="false">
    Common questions about the offer-to-cash process.
  </Card>
</Columns>
