...
<Steps>
  <Step title="Create the trailer record" icon="plus-circle" titleType="h3">
  ...
  <Step title="Set critical properties" icon="settings" titleType="h3">
  ...
  <Step title="Upload documents" icon="paperclip" titleType="h3">
  ...
  <Step title="Add the first technical inspection" icon="clipboard-check" titleType="h3">
  ...
  <Step title="Verify the trailer is available" icon="check-circle" titleType="h3">
...
<Columns cols="2">
  <Card title="Trailer Details" href="/user-guide/fleet/trailer-details" icon="file-text" horizontal="false">
    Complete reference for all trailer detail fields and tabs.
  </Card>
  ...
  <Card title="Documents" href="/user-guide/fleet/documents" icon="paperclip" horizontal="false">
    Uploading and managing trailer documents.
  </Card>

  <Card title="Status Changes" href="/user-guide/fleet/status-changes" icon="refresh-cw" horizontal="false">
    Understanding trailer status transitions and rules.
  </Card>
</Columns>
