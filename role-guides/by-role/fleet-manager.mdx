...
<Steps>
  <Step title="Check Dashboard notifications" icon="bell" titleType="p">
  ...
  <Step title="Address inspection alerts" icon="clipboard-check" titleType="p">
  ...
  <Step title="Register km readings" icon="gauge" titleType="p">
  ...
  <Step title="Manage non-productive periods" icon="pause-circle" titleType="p">
  ...
  <Step title="Check the Planning timeline" icon="calendar-days" titleType="p">
...
See [Fleet Onboarding Workflow](/role-guides/workflows/fleet-onboarding) for the complete step-by-step process.

## Related guides

<Columns cols="2">
  <Card title="Fleet Onboarding" href="/role-guides/workflows/fleet-onboarding" icon="truck" horizontal="false">
    Complete workflow for adding a new trailer to the fleet.
  </Card>

  <Card title="Inspections" href="/user-guide/fleet/inspections" icon="clipboard-check" horizontal="false">
    Managing technical inspections and validity tracking.
  </Card>

  <Card title="Km Registration" href="/user-guide/fleet/km-registration" icon="gauge" horizontal="false">
    Recording and importing kilometer readings.
  </Card>

  <Card title="Trailer Return Workflow" href="/role-guides/workflows/trailer-return" icon="undo" horizontal="false">
    The post-return inspection and damage control flow.
  </Card>
</Columns>
