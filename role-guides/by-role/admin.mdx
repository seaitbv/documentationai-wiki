...
| Companies | Full | Manage company details, logos, and VAT information |
| Locations | Full | Create and manage pick-up locations per company |
| Users | Full | Create, edit, and deactivate user accounts and assign roles |
| Communication | Full | View all sent emails, mark drafts as sent |
| Notifications | Full | View and manage all system notifications |
| Import/Export | Full | Import bulk data (km registrations) and view import history |
| Integrations | Full | Monitor Exact Online exports, manage Outlook connections |
| Audit Log | Full | View complete change history across all entities |
