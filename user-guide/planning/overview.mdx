...
The timeline displays several types of events as colored bars. See [Reading the timeline](/user-guide/planning/reading-timeline) for a complete guide to interpreting colors and interactions.
...
<Columns cols="2">
  <Card title="Reading the timeline" href="/user-guide/planning/reading-timeline" icon="eye" horizontal="false">
    Learn how to interpret colors, bars, and highlights.
  </Card>

  <Card title="Creating NP periods" href="/user-guide/planning/creating-np-periods" icon="calendar-plus" horizontal="false">
    Add non-productive periods directly from the planning view.
  </Card>
</Columns>
