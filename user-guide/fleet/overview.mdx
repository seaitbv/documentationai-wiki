...
<Callout kind="info">
  Status changes between states follow specific rules and validations. See [Status changes](/user-guide/fleet/status-changes) for the full transition diagram.
</Callout>
...
Click any row in the fleet list to navigate to the [trailer detail screen](/user-guide/fleet/trailer-details) for that trailer.

## Related pages

<Columns cols="2">
  <Card title="Trailer details" href="/user-guide/fleet/trailer-details" icon="file-text" horizontal="false">
    View and edit all information for a specific trailer.
  </Card>

  <Card title="Status changes" href="/user-guide/fleet/status-changes" icon="arrow-right-left" horizontal="false">
    Understand the rules governing trailer status transitions.
  </Card>
</Columns>
