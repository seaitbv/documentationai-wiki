...
<Callout kind="info">
  The default deposit amount is set in [Parameters](/user-guide/administration/parameters). Your administrator can change this value at any time, and new contracts will use the updated default.
</Callout>
...
<Steps>
  <Step title="Advance invoice is created" icon="file-text" titleType="p">
    A new invoice of type **Advance invoice** is created for the advance amount. It appears in the [invoice overview](/user-guide/invoicing/overview) with status "Created".
  </Step>

  <Step title="Deposit invoice is created" icon="file-text" titleType="p">
    A new invoice of type **Deposit invoice** is created for the deposit amount. It also appears with status "Created".
  </Step>
</Steps>

<Callout kind="alert">
  These invoices are created automatically. You do not need to create them manually. Check the [invoice overview](/user-guide/invoicing/overview) after a contract enters "In rental" to verify they are there.
</Callout>
...
See [Managing invoices](/user-guide/invoicing/managing-invoices) for more details on how advance offsets appear on invoices.
...
<Columns cols="2">
  <Card title="Contract lifecycle" href="/user-guide/contracts/lifecycle" icon="git-branch" horizontal="false">
    See when automatic invoices are triggered in the status flow.
  </Card>

  <Card title="Invoicing overview" href="/user-guide/invoicing/overview" icon="receipt" horizontal="false">
    View and manage all invoices including advance and deposit invoices.
  </Card>
</Columns>
