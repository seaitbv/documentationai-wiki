...
<ExpandableGroup>
  <Expandable title="I cannot sign in with my Microsoft account" default-open="false">
    **Possible causes and solutions:**

    <Steps>
      <Step title="Check your Microsoft account" icon="user" titleType="p">
      ...
      <Step title="Check your browser" icon="globe" titleType="p">
      ...
      <Step title="Verify your account is provisioned" icon="shield" titleType="p">
      ...
      <Step title="Check Azure AD status" icon="cloud" titleType="p">
  ...
  <Expandable title="My session expired unexpectedly" default-open="false">
  ...
  <Expandable title="I see a 'No access' or 'Unauthorized' message after logging in" default-open="false">
...
<ExpandableGroup>
  <Expandable title="The 'Send via email' button does not work or shows an error" default-open="false">
    ...
    <Steps>
      <Step title="Check your Microsoft connection" icon="cloud" titleType="p">
      ...
      <Step title="Verify Outlook permissions" icon="mail" titleType="p">
      ...
      <Step title="Check the contact email" icon="user" titleType="p">
      ...
      <Step title="Try again" icon="refresh-cw" titleType="p">
  ...
  <Expandable title="The offer/contract PDF is not attached to the email" default-open="false">
    **Possible causes:**

    - **Template is missing**: verify that an active template exists for the selected company, document type, and language. Contact your Administrator to check the [Templates](/user-guide/administration/templates) configuration.
  ...
  <Expandable title="Trailer photos are not attached to the offer email" default-open="false">
...
<ExpandableGroup>
  <Expandable title="VIES check returns 'Service temporarily unavailable'" default-open="false">
  ...
  <Expandable title="VIES check returns 'VAT number not found'" default-open="false">
    **Common causes:**
...
<ExpandableGroup>
  <Expandable title="Invoice proposal shows 'Fully invoiced' for a contract I have not invoiced" default-open="false">
  ...
  <Expandable title="Invoice proposal shows a red row for a km-based contract" default-open="false">
  ...
  <Expandable title="The advance offset line is not appearing on the first recurrent invoice" default-open="false">
  ...
  <Expandable title="Invoice totals do not match my manual calculation" default-open="false">
    ...
    See the invoicing calculation guides: [Day-Based](/user-guide/invoicing/day-based) | [Month-Based](/user-guide/invoicing/month-based) | [Km-Based](/user-guide/invoicing/km-based)
  </Expandable>
</ExpandableGroup>
...
<ExpandableGroup>
  <Expandable title="Export to Exact Online fails with an error" default-open="false">
    <Steps>
      <Step title="Read the error message" icon="alert-triangle" titleType="p">
      ...
      <Step title="Fix the underlying issue" icon="wrench" titleType="p">
      ...
      <Step title="Retry the export" icon="refresh-cw" titleType="p">
  ...
  <Expandable title="Invoice was exported but payment status is not updating" default-open="false">
...
<ExpandableGroup>
  <Expandable title="File upload fails with 'File too large'" default-open="false">
  ...
  <Expandable title="File upload fails with 'Unsupported format'" default-open="false">
  ...
  <Expandable title="Uploaded document does not appear in the list" default-open="false">
    **Possible causes:**
...
1. Check the [FAQ](/help/faq) for answers to common questions.
2. Review the relevant [User Guide](/getting-started/introduction) section for detailed instructions.
...
<Columns cols="2">
  <Card title="FAQ" href="/help/faq" icon="message-circle" horizontal="false">
    Answers to frequently asked questions about ARMS.
  </Card>
